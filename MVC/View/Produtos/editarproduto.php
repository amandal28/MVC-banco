...
<body>
    <form method="POST">
        ...
        <input type="text" name="quantidade" value="<?= $produtos['quantidade'] ?>" required />
        <br><br>
        <label for="codigo">Código de Barra: </label>
        <input type="text" name="codigo" value="<?= $produtos['codigo'] ?>" required />
        <br><br>
        <label for="preco">Preço: </label>
        <input type="text" name="preco" value="<?= $produtos['preco'] ?>" required />
        <br><br>
        <input type="submit">
    </form>
</body>
